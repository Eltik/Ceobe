// ExcelTables likely will need to be updated as new tables are added to the game data
// https://github.com/Kengxxiao/ArknightsGameData_YoStar/tree/main/en_US/gamedata/excel
