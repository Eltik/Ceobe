...
export default {
    data: new SlashCommandBuilder().setName("create-guide").setDescription("Guide on how to use the /create-guild command.").setDefaultMemberPermissions(PermissionFlagsBits.ManageMessages),
